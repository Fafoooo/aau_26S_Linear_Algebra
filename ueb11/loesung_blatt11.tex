...
\textbf{Schritt 3: Faktorisieren.} Mit $-1$ ausgeklammert: $\chi_A(t) = -(t^3 - 11t^2 + 39t - 45)$. Ganzzahlige Nullstellen sind Teiler von $45$ -- Ausprobieren zeigt: $t = 3$ und $t = 5$ ergeben $0$. Die dritte Nullstelle liefert die Spur ($3 + 5 + \lambda_3 = 11$): $\lambda_3 = 3$.
\[
\boxed{\chi_A(t) = (3-t)^2(5-t)} \qquad\Rightarrow\qquad \lambda = 3\ (\text{AM }2),\quad \lambda = 5\ (\text{AM }1).
\]
...
\textbf{Faktorisieren.} $\chi_B(t) = -(t^3 - 8t^2 + 20t - 16)$. Teiler von $16$ testen: $t = 2$ und $t = 4$ ergeben $0$. Dritte Nullstelle aus der Spur ($2 + 4 + \lambda_3 = 8$): $\lambda_3 = 2$.
\[
\boxed{\chi_B(t) = (2-t)^2(4-t)} \qquad\Rightarrow\qquad \lambda = 2\ (\text{AM }2),\quad \lambda = 4\ (\text{AM }1).
\]
