...
\textbf{Step 3: Factor.} Factoring out $-1$: $\chi_A(t) = -(t^3 - 11t^2 + 39t - 45)$. Integer roots are divisors of $45$ -- trying them shows: $t = 3$ and $t = 5$ give $0$. The third root comes from the trace ($3 + 5 + \lambda_3 = 11$): $\lambda_3 = 3$.
\[
...
\textbf{Factor.} $\chi_B(t) = -(t^3 - 8t^2 + 20t - 16)$. Test divisors of $16$: $t = 2$ and $t = 4$ give $0$. Third root from the trace ($2 + 4 + \lambda_3 = 8$): $\lambda_3 = 2$.
\[
